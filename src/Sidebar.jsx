...
export default function Sidebar() {
  ...
  return (
    <div className="bg-boxclr z-20 md:w-52 bottom-0 left-0 shadow-md md:p-6 fixed w-full h-16 rounded-none md:rounded-l-2xl rounded-r-none md:min-h-screen md:h-full flex gap-10 flex-row md:flex-col justify-start">
